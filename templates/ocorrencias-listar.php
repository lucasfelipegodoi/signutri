...
?>
 	<div id="pageListar">
		...
		<fieldset>
			<legend>
				<?php echo $GLOBALS['text']['ocorrencias_listar_titulo']; ?>
			</legend>
			<table id="listar" cellpadding="0" cellspacing="0" border="0" class="display">
				<thead>
					<tr>
						<th width="15%"><?php echo $GLOBALS['text']['ocorrencias_localizacao']; ?></th>
						<th width="*"><?php echo $GLOBALS['text']['ocorrencias_titulo']; ?></th>
						<th width="60"><?php echo $GLOBALS['text']['ocorrencias_acoes']; ?></th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<p class="linkAdd"><a href="?m=unidades-saude&a=adicionar" title="<?php echo $GLOBALS['text']['ocorrencias_adicionar_nova']; ?>"><img src="<?php echo IMAGENSPATH."add.png";  ?>" alt="<?php echo $GLOBALS['text']['ocorrencias_adicionar_nova']; ?>" style="margin-bottom:3px;vertical-align:middle"/> <?php echo $GLOBALS['text']['ocorrencias_adicionar_nova']; ?></a></p>
	</div>
<?php
	loadTemplate('footer');
?>