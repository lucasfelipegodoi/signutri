...
?>
 	<div id="pageListar">
		...
		<fieldset>
			<legend>
				<?php echo $GLOBALS['text']['meio_notificacao_listar_titulo']; ?>
			</legend>
			<table id="listar" cellpadding="0" cellspacing="0" border="0" class="display">
				<thead>
					<tr>
						<th width="*"><?php echo $GLOBALS['text']['meio_notificacao_nome']; ?></th>
						<th width="60"><?php echo $GLOBALS['text']['meio_notificacao_acoes']; ?></th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<p class="linkAdd"><a href="?m=meio-notificacao&a=adicionar" title="<?php echo $GLOBALS['text']['meio_notificacao_adicionar_novo']; ?>"><img src="<?php echo IMAGENSPATH."add.png";  ?>" alt="<?php echo $GLOBALS['text']['meio_notificacao_adicionar_novo']; ?>" style="margin-bottom:3px;vertical-align:middle"/> <?php echo $GLOBALS['text']['meio_notificacao_adicionar_novo']; ?></a></p>
	</div>
<?php
	loadTemplate('footer');
?>